...
extern Cvar::Cvar<int> g_ffVotesPercent;
...
extern Cvar::Range<Cvar::Cvar<int>> g_bot_defaultSkill;
...
extern Cvar::Cvar<int> g_bot_chasetimeCampy;
extern Cvar::Cvar<int> g_bot_alienSenseRangeCampy;
